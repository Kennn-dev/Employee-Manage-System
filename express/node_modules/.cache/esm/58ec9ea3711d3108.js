let Employee,Admin,ApolloError,AuthenticationError,sign,verify,error,compare,hash;_711‍.x([["default",()=>_711‍.o]]);_711‍.w("../../models/Employee",[["default",["Employee"],function(v){Employee=v}]]);_711‍.w("../../models/Admin",[["default",["Admin"],function(v){Admin=v}]]);_711‍.w("apollo-server-express",[["ApolloError",["ApolloError"],function(v){ApolloError=v}],["AuthenticationError",["AuthenticationError"],function(v){AuthenticationError=v}]]);_711‍.w("jsonwebtoken",[["sign",["sign"],function(v){sign=v}],["verify",["verify"],function(v){verify=v}]]);_711‍.w("consola",[["error",["error"],function(v){error=v}]]);_711‍.w("bcrypt",[["compare",["compare"],function(v){compare=v}],["hash",["hash"],function(v){hash=v}]]);
...
_711‍.d({
  ...
  Mutation: {
    ...
    createNewEmployee: async (_, { newEmployee }, { req }, info) => {
      ...
      _711‍.g.console.log(newEmployee);
